...
{
    public static class BlobMonitoring2
    {
        [FunctionName("BlobMonitoring2")]
        public static async Task Run(
            [BlobTrigger("mlstudio3/encoded2.txt", Connection = "BlobContainerConnection")] Stream encodedChartStream,
            [Blob("mlstudio3/chart2.pdf", FileAccess.Write, Connection = "BlobContainerConnection")] Stream outputChartStream,
            TraceWriter log)
        {
